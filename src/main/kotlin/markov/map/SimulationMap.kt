...
data class SimulationMap(
    ...
    companion object {
        ...
        fun of(mapSize: MapSize, rawMap: List<String>, output: MessageOutput): SimulationMap {
            ...
            output.println(Message(MessageType.SUCCESS, "지도를 불러왔습니다"))
            return SimulationMap(size = mapSize, start = start, destination = destination, current = start)
        }

        fun initializeFrom(mapStream: InputStream, output: MessageOutput): SimulationMap {
            ...
            return of(mapSize, map.subList(1, map.size), output)
        }
